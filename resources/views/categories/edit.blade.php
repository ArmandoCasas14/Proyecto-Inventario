            ...
            <div class="bg-emerald-600 dark:bg-emerald-700 px-6 py-6 sm:px-8 flex items-center justify-between gap-4">
                <div>
                    ...
                    <p class="text-xs text-emerald-100 mt-1">
                        {{ __('Modifica la información básica de la categoría seleccionada.') }}
                    </p>
                </div>
                ...
                <form method="POST" action="{{ route('categorias.update', $category) }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" rows="4"
                                  class="mt-1.5 block w-full text-xs rounded-xl border-slate-200 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-200 focus:border-emerald-500 focus:ring-emerald-500 shadow-sm">{{ old('description', $category->description) }}</textarea>
